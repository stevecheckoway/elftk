...
constants!(type_name, Elf_Half, {
    ...
    /// Core file.
    ET_CORE = (4, "CORE"),
    /// OS-specific file type minimum.
    ET_LOOS,
    /// OS-specific file type maximum.
    ET_HIOS = (0xfe00, 0xfeff, "OS"),
    /// Processor-specific file type minimum.
    ET_LOPROC,
    /// Processor-specific file type maximum.
    ET_HIPROC = (0xff00, 0xffff, "PROC")
});
...
///
/// Alias of [EM_ECOG1](constants.EM_ECOG1.html).
pub const EM_ECOG1X: Elf_Half = EM_ECOG1;
...
constants!(section_type_name, Elf_Word, {
    ...
    SHT_LOOS, SHT_HIOS = (0x6000_0000, 0x6fff_ffff, "OS"),
    SHT_LOPROC, SHT_HIPROC = (0x7000_0000, 0x7fff_ffff, "PROC"),
    SHT_LOUSER, SHT_HIUSER = (0x8000_0000, 0xffff_ffff, "USER")
});
...
constants!(symbol_binding_name, u8, {
    ...
    STB_GLOBAL = (1, "GLOBAL"),
    STB_WEAK   = (2, "WEAK"),
    STB_LOOS, STB_HIOS = (10, 12, "OS"),
    STB_LOPROC, STB_HIPROC = (13, 15, "PROC")
});
...
constants!(symbol_type_name, u8, {
    ...
    STT_COMMON  = (5, "COMMON"),
    STT_TLS     = (6, "TLS"),
    STT_LOOS, STT_HIOS = (10, 12, "OS"),
    STT_LOPROC, STT_HIPROC = (13, 15, "PROC")
});
...
constants!(segment_type_name, Elf_Word, {
    ...
    PT_PHDR    = (6, "PHDR"),
    PT_TLS     = (7, "TLS"),
    PT_LOOS, PT_HIOS = (0x6000_0000, 0x6fff_ffff, "OS"),
    PT_LOPROC, PT_HIPROC = (0x7000_0000, 0x7fff_ffff, "PROC")
});
